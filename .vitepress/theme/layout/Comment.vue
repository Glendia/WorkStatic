...
const init = () => {
  if (inBrowser) {
    ...
    gitTalk = new Gitalk({
      ...
      owner: 'Glendia', // GitHub repository 所有者
      repo: 'WorkStatic-issues', // GitHub repo
      clientID: 'Ov23li3tK8Gltt4IGcvj', // clientID
      clientSecret: 'dc268ff011690fe219a7282165895283605625e5', // clientSecret
      admin: ['Glendia'], // GitHub repo 所有者
